...
import { TARGET_PORTFOLIO, BLUE, ORANGE } from '../constants';
...
const EnterDetailsScreen: React.FC<Props> = ({ onSubmit, result }) => {
  ...
  async function handleSubmit() {
    ...
    try {
      let finalScore = 0;
      if (result) {
        finalScore = Math.min(100, Math.max(0, Math.round((result.portfolio / TARGET_PORTFOLIO) * 100)));
      }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-center text-sm text-gray-400 mb-7">To view your score & leaderboard</p>
