...
const RetirementReveal: React.FC<Props> = ({ score, onNext }) => {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center bg-white">
      ...
      <h2 className="text-2xl font-bold text-slate-900 mb-2">Plan Balanced!</h2>
      <p className="text-slate-500 mb-8 font-medium">A balanced plan ensures a smooth life.</p>
      
      <div className="w-full bg-slate-50 rounded-3xl p-8 border border-slate-100 mb-8 relative">
        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Expected Retirement Fund</p>
        <p className="text-5xl font-black text-blue-600 mb-6">₹50,00,000</p>
        
        <div className="h-px bg-slate-200 w-full mb-6"></div>
        
        <p className="text-sm font-medium text-slate-600 mb-2 italic">But is it enough for your lifestyle?</p>
      ...
      <p className="text-slate-600 text-sm mb-10 px-4 leading-relaxed">
        Did you know your grid items represent the <span className="font-bold text-slate-900 underline decoration-blue-500 decoration-2">pillars of an Annuity Plan</span>?
      </p>
