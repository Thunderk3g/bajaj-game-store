...
const IntroScreen: React.FC<Props> = ({ onPlay }) => (
  <div className="relative h-full min-h-0 w-full overflow-hidden bg-[#04080F]">
    <img
      src={INTRO_IMAGE}
      alt=""
    ...
    />
    <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_30%,rgba(0,180,255,0.06),rgba(0,0,0,0.1)_30%,rgba(0,0,0,0.7)_100%)]" />
    <div
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          boxShadow: '0 0.6rem 2rem rgba(255,185,0,0.55), inset 0 0.15rem 0 rgba(255,255,255,0.3), 0 0 0 2px rgba(255,210,0,0.35)',
        }}
      >
        Play
      </button>
