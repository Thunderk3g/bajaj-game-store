import{r as i,j as s,A as f,m}from"./index.js";const I=async t=>{const e="https://sales.bajajlife.com/BalicLmsUtil/whatsappInhouse",r=sessionStorage.getItem("gamification_userId")||"",o=sessionStorage.getItem("gamification_gameId")||"",n={cust_name:t.name||t.fullName||"",mobile_no:t.mobile_no||t.contact_number||"",dob:"",gender:"M",pincode:"",email_id:t.email_id||"",life_goal_category:"",investment_amount:"",product_id:"",p_source:sessionStorage.getItem("gamification_referral")==="Y"?"Referral":"Marketing Assist",p_data_source:"GAMIFICATION",pasa_amount:"",product_name:"",pasa_product:"",associated_rider:"",customer_app_product:"",p_data_medium:" GAMIFICATION ",utmSource:"",userId:r,gameID:o,remarks:`Game: ${o}${t.score!=null?` | Score: ${t.score}`:""} | ${t.summary_dtls||"Retirement Readiness Lead"}`,appointment_date:"",appointment_time:""};console.log("[API] Submitting lead to WhatsApp Inhouse API:",n);try{const a=await fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)}),c=await a.json().catch(()=>({}));return{success:a.ok,...c}}catch(a){return console.error("LMS Submission Error:",a),{success:!1,error:a.message}}},k=async(t,e)=>{const r="https://sales.bajajlife.com/BalicLmsUtil/updateLeadNew",o={leadNo:t,tpa_user_id:"",miscObj1:{stringval1:"",stringval2:e.name||e.firstName||"",stringval3:e.lastName||"",stringval4:e.date||"",stringval5:e.time||"",stringval6:e.remarks||"Slot Booking via Game",stringval7:"GAMIFICATION",stringval9:e.mobile||""}};try{const n=await fetch(r,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(o)}),a=await n.json().catch(()=>({}));return{success:n.ok,...a}}catch(n){return console.error("updateLeadNew Submission Error:",n),{success:!1,error:n.message}}};/**
