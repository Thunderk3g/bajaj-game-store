                    ...
                    {step.options.map((option) => {
                        ...
                        return (
                            <button
                                ...
                                className={cn(
                                    "flex items-center p-3 sm:p-4 rounded-xl sm:rounded-2xl transition-all duration-300 text-left",
                                    "bg-white/90 backdrop-blur-xl shadow-md sm:shadow-lg hover:shadow-xl hover:-translate-y-1",
                                    isSelected
