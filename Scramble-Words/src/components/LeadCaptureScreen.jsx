...
const LeadCaptureScreen = ({ onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await submitToLMS({
                name: name.trim(),
                mobile_no: phone,
                summary_dtls: 'Scramble Words - Post Game Lead'
            });
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-50 flex items-center justify-center p-6 game-bg-gradient"
        >
            <motion.div
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="space-y-6 text-left">
                    <div className="space-y-1.5 text-left">
                        ...
                        />
                        {errors.name && <p className="text-red-500 text-[10px] font-black uppercase tracking-wider ml-1 text-left">{errors.name}</p>}
                    </div>
                    ...
                    <div className="space-y-1.5 text-left">
                        ...
                        />
                        {errors.phone && <p className="text-red-500 text-[10px] font-black uppercase tracking-wider ml-1 text-left">{errors.phone}</p>}
                    </div>
                    ...
                    >
                        {isSubmitting ? 'Starting...' : 'Reveal Score!'}
                    </button>
