...
export const submitToLMS = async (data) => {
    ...
    const gameID = sessionStorage.getItem('gamification_gameId') || 'Future-Climb';
    ...
    const payload = {
        ...
        userId: userId,
        gameID: gameID,
        remarks: `Game: ${gameID}${data.score != null ? ` | Score: ${data.score}` : ''} | ${data.summary_dtls || "Future Climb Lead"}`,
