...
const EnterDetailsScreen: React.FC<Props> = ({ onSubmit }) => {
  ...
  return (
    <div className="screen-scroll" style={{ background: `linear-gradient(170deg, #001230, ${BLUE})` }}>
      ...
      <div className="w-full max-w-sm mx-auto flex flex-col items-center px-6 pt-8 pb-10 min-h-screen">
        ...
        <div className="text-center mb-6 pop">
          ...
          <h2 className="text-white text-2xl font-extrabold">Time's Up!</h2>
          <p className="text-blue-200 text-sm mt-1">
            Share your details to unlock your<br />
            <span className="font-bold text-white">ULIP Portfolio Score</span>
          </p>
        </div>
          ...
          <div className="mb-5">
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-xs text-gray-500 leading-relaxed">
                ...
                <button
                  className="font-bold underline btn-press"
                  style={{ color: BLUE }}
